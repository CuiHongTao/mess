...
<body class="loading-process">
	<div class="loading">
		...
		<div class="loading-avatar">
			<img src="images/avatar@2x.jpg" alt="" width="100" height="100">
		</div>
	...
	<div class="section-header">
		<div class="section">
			...
			<ul>
				<li class="nav-about fade fade1"><a href="#about">操作</a></li>
				<li class="nav-works fade fade4"><a href="#works">关注</a></li>
	...
	<div class="section-wrap section-fristpage" data-slide="1">
		<div class="section">
			<div class="section-content">
				<p class="fade fade1">Hi，我是 ${username }</p>
				<p class="fade fade2">这是我的账户管理页面</p>
	...
	<div id="about" data-slide="2" data-stellar-background-ratio="0.3"
		...
		<div class="section">
			<div class="about-content clearfix section-content">
				<div class="introli">
					<h1><a href="Change.jsp">更改 密码</a></h1>
				</div>
				<div class="introli">
					<h1><a href="Delete.jsp">删除 账户</a></h1>
				</div>
				<div class="introli">
					<h1>更多 功能</h1>
				</div>
		...
		<a class="button2 dark-button2 scroll-tip"
			style="background-position: 0 -60px;" data-slide="3" title=""></a>
	</div>
				...
				<div class="works-list clearfix">
					<div class="works-item first fade fade1">
						<a href="#" target="_blank"> <img
							src="images/works/yizaojia.jpg" alt="" width="300" height="180">
							<div class="work-info">
								<h2>不拉不拉</h2>
								<p>
									<strong>性别</strong>：不明<br> <strong>年龄</strong>：不明<br>
									<strong>留言</strong>：不拉淘宝店铺倒闭清仓大甩卖了，原价70元，60元，50元的商品，现在统统只要1元钱，是的，只要1元钱。一元钱，你买不了吃亏，一元钱，你买不了上当，走过路过，千万不要错过。
								</p>
							</div>
						</a>
					</div>
					<div class="works-item fade fade2">
						<a href="#/" target="_blank"> <img
							src="images/works/91zaojia.jpg" alt="" width="300" height="180">
							<div class="work-info">
								<h2>喜欢我做的东西就关注我把！</h2>
								<p>
									<strong>开发时间</strong>：2013年10月<br> <strong>工作详情</strong>：页面设计及前端制作。
								</p>
							</div>
						</a>
					</div>
					<div class="works-item fade fade3">
						<a href="#/" target="_blank"> <img
							src="images/works/wenku.jpg" alt="" width="300" height="180">
							<div class="work-info">
								<h2>喜欢我做的东西就关注我把！</h2>
								<p>
									<strong>开发时间</strong>：2013年12月<br> <strong>工作详情</strong>：页面设计及前端绑定和制作。
								</p>
							</div>
						</a>
					</div>
					<div class="works-item first fade fade4">
						<a href="#" target="_blank"> <img
							src="images/works/shinedeliver.jpg" alt="" width="300"
							height="180">
							<div class="work-info">
								<h2>喜欢我做的东西就关注我把！</h2>
								<p>
									<strong>开发时间</strong>：2012年11月<br> <strong>工作详情</strong>：独立开发和制作。
								</p>
							</div>
						</a>
					</div>
					<div class="works-item fade fade2">
						<a> <img src="images/works/wxshop.jpg" alt="" width="300"
							height="180">
							<div class="work-info">
								<h2>喜欢我做的东西就关注我把！</h2>
								<p>
									<strong>开发时间</strong>：2014年05月<br> <strong>工作详情</strong>：前端页面开发及绑定。
								</p>
							</div>
						</a>
					</div>
	...
	<div id="skill" class="section-wrap section-skill" data-slide="4">
		<div class="section">
			<div class="skill-content section-content">
				<h1>相关技能</h1>
				<ul>
					<li class="fade fade1">熟练掌握语义化的 HTML 和具有兼容性的 CSS 模式，熟练手写符合 W3C
						标准的结构和代码。</li>
	...
	<div id="contact" class="section-wrap section-contact" data-slide="5">
		<div class="section">
			<div class="contact-content clearfix section-content">
				...
				<div class="right fade fade3">
					...
					<p>
						<strong>适用浏览器</strong>：360、FireFox、Chrome、Safari、Opera、傲游、搜狗、世界之窗.
						不支持IE8及以下浏览器。
					</p>
		...
		<a class="button2 button2-2-top scroll-tip" id="gototops"
			...
			style="background-position: -60px 0; width: 80px; height: 80px;"
			title=""></a>
	</div>
